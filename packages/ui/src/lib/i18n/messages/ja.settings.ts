...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'ollama.com のブラウザー開発者ツールのリクエストヘッダーから完全な Cookie ヘッダーをコピーして、ここに貼り付けてください。aid=... と現在の wos-session=... Cookie（古いアカウントでは __Secure-session=... の場合があります）を含め、他の Cookie も残してください。これはローカルの Ollama API キーやエンドポイントではありません。OpenChamber がブラウザーの Cookie 保存領域を走査することはありません。',
