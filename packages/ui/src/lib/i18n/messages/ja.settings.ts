...
'settings.remoteInstances.clientAuth.actions.addDevice': 'デバイスを追加',
  ...
  'settings.openchamber.opencodeCli.field.idleInstanceTimeout': 'アイドルインスタンスの解放時間',
  'settings.openchamber.opencodeCli.field.idleInstanceTimeoutInfo': '管理された OpenCode インスタンスは、この時間アクティビティがないと解放されます。解放すると、アイドル状態のプロジェクトが保持している MCP サーバー、言語サーバー、キャッシュがメモリから解放されます。その後、そのプロジェクトで最初の操作をするときは、インスタンスの再起動のため少し時間がかかります。',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.never': '解放しない',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.15m': '15分',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.30m': '30分',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.1h': '1時間',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.4h': '4時間',
