...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'Copiez l’en-tête Cookie complet parmi les en-têtes de requête dans les outils de développement du navigateur sur ollama.com, puis collez-le ici. Il doit contenir aid=... et le cookie actuel wos-session=... (les anciens comptes peuvent utiliser __Secure-session=...). Conservez aussi les autres cookies. Il ne s’agit pas d’une clé API ni d’un endpoint Ollama local. OpenChamber n’analyse jamais le stockage des cookies du navigateur.',
  'settings.providers.page.ollamaCloud.cookie': 'En-tête Cookie',
