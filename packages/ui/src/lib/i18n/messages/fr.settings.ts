...
export const settingsDict = {
  ...
  'settings.magicPrompts.sidebar.group.composer': 'Composeur',
  ...
  'settings.magicPrompts.sidebar.item.composerEnhance': 'Amélioration de prompt',
...
'settings.remoteInstances.clientAuth.actions.addDevice': 'Ajouter un appareil',
  ...
  'settings.magicPrompts.page.group.composerEnhance.title': 'Amélioration de prompt',
  ...
  'settings.magicPrompts.page.group.composerEnhance.description': 'Prompt utilisé par l\'action « Améliorer le prompt » du composeur : instructions masquées qui réécrivent votre brouillon avec le petit modèle avant l\'envoi.',
