...
export const settingsDict = {
  ...
  'settings.openchamber.opencodeCli.field.idleInstanceTimeout': 'Libérer les instances inactives après',
  'settings.openchamber.opencodeCli.field.idleInstanceTimeoutInfo': 'Les instances OpenCode gérées sont libérées après cette durée sans activité. Elle libère la mémoire occupée par les serveurs MCP, les serveurs de langage et les caches qu\'un projet inactif conserve ; la première action dans ce projet prend ensuite un moment, le temps que l\'instance redémarre.',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.never': 'Jamais',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.15m': '15 minutes',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.30m': '30 minutes',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.1h': '1 heure',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.4h': '4 heures',
