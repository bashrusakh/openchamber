...
export const dict = {
  ...
  'sessions.sidebar.dialogs.worktreeDelete.disposition.label': 'Linked sessions',
  'sessions.sidebar.dialogs.worktreeDelete.disposition.archive': 'Archive linked sessions',
  'sessions.sidebar.dialogs.worktreeDelete.disposition.delete': 'Delete linked sessions permanently',
  'sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionOneLinked': 'This removes the selected worktree and permanently deletes {count} linked session.',
  'sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionManyLinked': 'This removes the selected worktree and permanently deletes {count} linked sessions.',
