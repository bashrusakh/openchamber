...
export const dict = {
  ...
  'chat.consult.action': 'Consult models',
  'chat.consult.action.hint': 'Ask other models first; their answers may be added as a private hint',
  'chat.consult.unavailable.noSession': 'Open a session to consult other models',
  'chat.consult.unavailable.slashCommand': 'Consult models is unavailable for slash commands',
  'chat.consult.unavailable.shellCommand': 'Consult models is unavailable for shell commands',
  'chat.consult.unavailable.active': 'A consultation is already running in this session',
  ...
  'chat.consult.dialog.advisorsLabel': 'Advisors',
  'chat.consult.dialog.modeLabel': 'Run',
  'chat.consult.dialog.mode.parallel': 'Parallel',
  'chat.consult.dialog.mode.sequential': 'Sequential',
  'chat.consult.dialog.timeoutLabel': 'Timeout per advisor',
  ...
  'chat.consult.dialog.privacy': 'Advisors receive your message, the current context, and any attachments. They run as temporary sessions with tools disabled, and never see each other’s answers.',
  'chat.consult.dialog.actions.cancel': 'Cancel',
  ...
  'chat.consult.panel.phase.settling': 'Collecting answers…',
  'chat.consult.panel.phase.dispatching': 'Sending the acting reply…',
  'chat.consult.panel.phase.done': 'Consultation finished',
  'chat.consult.panel.phase.failed': 'Consultation failed',
  'chat.consult.panel.phase.cancelled': 'Consultation cancelled',
  'chat.consult.panel.degraded': 'No usable advisor output; the message was sent with a notice',
  'chat.consult.panel.cancel': 'Cancel consultation',
  'chat.consult.panel.dismiss': 'Dismiss',
  'chat.consult.status.queued': 'Queued',
  'chat.consult.status.running': 'Running',
  'chat.consult.status.ok': 'Answered',
  'chat.consult.status.failed': 'Failed',
  'chat.consult.status.timeout': 'Timed out',
  'chat.consult.status.empty': 'No answer',
  'chat.consult.status.cancelled': 'Cancelled',
  'chat.consult.duration.seconds': '{seconds} s',
  'chat.consult.receipt.title': 'Consulted {count} models',
  'chat.consult.receipt.degraded': 'No usable advisor output',
  'chat.consult.receipt.acting': 'Acting: {model}',
  ...
  'chat.consult.rejection.agentUnknown': 'Advisor {index}: agent "{agent}" is not available',
  'chat.consult.rejection.agentNotPrimary': 'Advisor {index}: agent "{agent}" is not a primary agent',
  'chat.consult.rejection.unknown': 'Advisor {index}: this selection is not available',
} as const;
