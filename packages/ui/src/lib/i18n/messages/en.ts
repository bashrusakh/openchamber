...
export const dict = {
  ...
  'session.githubIssuePicker.overridesHelper': 'These selections apply only to the initial session message',
  ...
  'session.newWorktree.overridesHelper': 'These selections apply only to the initial session message',
