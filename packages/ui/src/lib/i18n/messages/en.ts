...
export const dict = {
  ...
  'chat.chatInput.actions.enhancePromptAria': 'Enhance prompt',
  'chat.chatInput.actions.enhancePromptCancel': 'Cancel prompt enhancement',
  ...
  'chat.chatInput.toast.enhanceUnavailable': 'No Small Model is available for prompt enhancement. Choose one in Settings → Sessions → Small Model.',
  'chat.chatInput.toast.enhanceContextTooSmall': 'The prompt is too large for the Small Model context. Shorten it or attach it as a file instead.',
  'chat.chatInput.toast.enhanceEmptyResult': 'The Small Model returned an empty prompt. Try enhancing again.',
  'chat.chatInput.toast.enhanceInvalidResult': 'The enhanced prompt would change your @, /, or # references. The draft was left unchanged.',
  'chat.chatInput.toast.enhanceTimedOut': 'Prompt enhancement timed out. Try again.',
