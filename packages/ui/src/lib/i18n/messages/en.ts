...
export const dict = {
  ...
  'session.githubIssuePicker.error.searchTimedOut': 'Search timed out. Try a more specific query.',
  ...
  'session.githubPrPicker.error.searchTimedOut': 'Search timed out. Try a more specific query.',
  ...
  'session.githubIntegration.error.searchTimedOut': 'Search timed out. Try a more specific query.',
  'session.githubIntegration.error.repoNotResolvable': 'Repo not resolvable',
