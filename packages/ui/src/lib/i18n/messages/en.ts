...
export const dict = {
  ...
  'session.githubIssuePicker.overridesHelper': 'These selections apply to this session (not your saved defaults)',
  ...
  'session.newWorktree.overridesHelper': 'These selections apply to this session (not your saved defaults)',
