...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.consult.action': 'モデルに相談',
  'chat.consult.action.hint': '先に他のモデルへ質問し、回答は非公開のヒントとして追加されることがあります',
  'chat.consult.unavailable.noSession': '他のモデルに相談するにはセッションを開いてください',
  'chat.consult.unavailable.slashCommand': 'スラッシュコマンドではモデルに相談できません',
  'chat.consult.unavailable.shellCommand': 'シェルコマンドではモデルに相談できません',
  'chat.consult.unavailable.active': 'このセッションではすでに相談が実行中です',
  ...
  'chat.consult.dialog.advisorsLabel': '相談先モデル',
  'chat.consult.dialog.modeLabel': '実行方法',
  'chat.consult.dialog.mode.parallel': '並列',
  'chat.consult.dialog.mode.sequential': '順次',
  'chat.consult.dialog.timeoutLabel': '相談先ごとのタイムアウト',
  'chat.consult.dialog.timeout.30s': '30 秒',
  'chat.consult.dialog.timeout.1m': '1 分',
  'chat.consult.dialog.timeout.2m': '2 分',
  'chat.consult.dialog.timeout.5m': '5 分',
  'chat.consult.dialog.privacy': '相談先モデルにはメッセージ、現在のコンテキスト、添付ファイルが送信されます。一時的なセッションでツールを無効にして実行され、他のモデルの回答も見えません。',
  'chat.consult.dialog.actions.cancel': 'キャンセル',
  ...
  'chat.consult.panel.phase.settling': '回答を収集中…',
  'chat.consult.panel.phase.dispatching': '実行モデルの返信を送信中…',
  'chat.consult.panel.phase.done': '相談が完了しました',
  'chat.consult.panel.phase.failed': '相談に失敗しました',
  'chat.consult.panel.phase.cancelled': '相談をキャンセルしました',
  'chat.consult.panel.degraded': '相談先から有効な回答が得られませんでした。メッセージは通知付きで送信されました',
  'chat.consult.panel.cancel': '相談をキャンセル',
  'chat.consult.panel.dismiss': '閉じる',
  'chat.consult.status.queued': '待機中',
  'chat.consult.status.running': '実行中',
  'chat.consult.status.ok': '回答済み',
  'chat.consult.status.failed': '失敗',
  'chat.consult.status.timeout': 'タイムアウト',
  'chat.consult.status.empty': '回答なし',
  'chat.consult.status.cancelled': 'キャンセル済み',
  'chat.consult.duration.seconds': '{seconds} 秒',
  'chat.consult.receipt.title': '{count} 件のモデルに相談しました',
  'chat.consult.receipt.degraded': '相談先から有効な回答が得られませんでした',
  'chat.consult.receipt.acting': '実行: {model}',
  ...
  'chat.consult.rejection.agentUnknown': 'アドバイザー {index}：エージェント「{agent}」は利用できません',
  'chat.consult.rejection.agentNotPrimary': 'アドバイザー {index}：エージェント「{agent}」はプライマリエージェントではありません',
  'chat.consult.rejection.unknown': 'アドバイザー {index}：この選択は利用できません',
};
