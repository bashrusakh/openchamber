...
export const settingsDict = {
  ...
  'settings.magicPrompts.sidebar.group.composer': '输入框',
  ...
  'settings.magicPrompts.sidebar.item.composerEnhance': '提示词优化',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.magicPrompts.page.group.composerEnhance.title': '提示词优化',
  'settings.magicPrompts.page.group.sessionFusion.description': '用于将多运行输出融合为一个最终答案的提示词：可见用户消息 + 源结果前的隐藏说明。',
  'settings.magicPrompts.page.group.composerEnhance.description': '输入框“优化提示词”操作使用的提示词：在发送前由小型模型重写草稿的隐藏说明。',
