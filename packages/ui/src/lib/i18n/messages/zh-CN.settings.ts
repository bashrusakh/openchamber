...
'settings.remoteInstances.clientAuth.actions.addDevice': '添加设备',
  ...
  'settings.openchamber.opencodeCli.field.idleInstanceTimeout': '空闲实例释放时间',
  'settings.openchamber.opencodeCli.field.idleInstanceTimeoutInfo': '受管理的 OpenCode 实例在此时长内没有活动后会被释放。释放会腾出空闲项目占用的 MCP 服务器、语言服务器和缓存内存；之后在该项目中的第一次操作会稍慢，因为实例需要重新启动。',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.never': '从不',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.15m': '15 分钟',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.30m': '30 分钟',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.1h': '1 小时',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.4h': '4 小时',
