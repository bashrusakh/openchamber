...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.consult.action': 'Konsultuj modele',
  'chat.consult.action.hint': 'Najpierw zapytaj inne modele; ich odpowiedzi mogą zostać dodane jako prywatna wskazówka',
  'chat.consult.unavailable.noSession': 'Otwórz sesję, aby konsultować inne modele',
  'chat.consult.unavailable.slashCommand': 'Konsultowanie modeli jest niedostępne dla poleceń z ukośnikiem',
  'chat.consult.unavailable.shellCommand': 'Konsultowanie modeli jest niedostępne dla poleceń powłoki',
  'chat.consult.unavailable.active': 'W tej sesji trwa już konsultacja',
  ...
  'chat.consult.unavailable.backendProtocol': 'Konsultowanie modeli wymaga nowszego serwera OpenChamber: połączony backend nie obsługuje protokołu kolejki konsultacji.',

  'chat.consult.dialog.title': 'Konsultuj modele',
  'chat.consult.dialog.description': 'Najpierw zadaj to samo pytanie innym modelom. Ich odpowiedzi mogą zostać dodane jako prywatna wskazówka na jedną turę; odpowiedź nadal pisze model wykonawczy.',
  'chat.consult.dialog.actingLabel': 'Model wykonawczy',
  'chat.consult.dialog.advisorsLabel': 'Modele doradcze',
  'chat.consult.dialog.modeLabel': 'Tryb',
  'chat.consult.dialog.mode.parallel': 'Równolegle',
  'chat.consult.dialog.mode.sequential': 'Sekwencyjnie',
  'chat.consult.dialog.timeoutLabel': 'Limit czasu na model doradczy',
  ...
  'chat.consult.dialog.privacy': 'Modele doradcze otrzymują Twoją wiadomość, bieżący kontekst i załączniki. Działają jako tymczasowe sesje z wyłączonymi narzędziami i nie widzą odpowiedzi innych.',
  'chat.consult.dialog.actions.cancel': 'Anuluj',
  'chat.consult.dialog.actions.submit': 'Konsultuj i wyślij',
  'chat.consult.dialog.actions.submitting': 'Uruchamianie…',
  'chat.consult.dialog.noAdvisorAgent': 'Brak głównego agenta dostępnego dla modeli doradczych',
  'chat.consult.panel.ready': '{ready} / {total} gotowych',
  'chat.consult.summary.segment': '{count} {status}',
  'chat.consult.panel.title': 'Konsultuj modele',
  'chat.consult.panel.phase.waitingAdmission': 'Oczekiwanie na kolejkę i bezczynność sesji…',
  'chat.consult.panel.phase.consulting': 'Konsultowanie {count} modeli…',
  'chat.consult.panel.phase.settling': 'Zbieranie odpowiedzi…',
  'chat.consult.panel.phase.dispatching': 'Wysyłanie odpowiedzi modelu wykonawczego…',
  'chat.consult.panel.phase.done': 'Konsultacja zakończona',
  'chat.consult.panel.phase.failed': 'Konsultacja nie powiodła się',
  'chat.consult.panel.phase.cancelled': 'Konsultacja anulowana',
  'chat.consult.panel.degraded': 'Brak użytecznych odpowiedzi modeli doradczych; wiadomość wysłano z ostrzeżeniem',
  'chat.consult.panel.cancel': 'Anuluj konsultację',
  'chat.consult.panel.dismiss': 'Zamknij',
  'chat.consult.status.queued': 'W kolejce',
  'chat.consult.status.running': 'W toku',
  'chat.consult.status.ok': 'Odpowiedziano',
  'chat.consult.status.failed': 'Niepowodzenie',
  'chat.consult.status.timeout': 'Przekroczono limit czasu',
  'chat.consult.status.empty': 'Brak odpowiedzi',
  'chat.consult.status.cancelled': 'Anulowano',
  'chat.consult.duration.seconds': '{seconds} s',
  'chat.consult.receipt.title': 'Skonsultowano {count} modeli',
  'chat.consult.receipt.degraded': 'Brak użytecznych odpowiedzi modeli doradczych',
  'chat.consult.receipt.acting': 'Wykonawczy: {model}',
  ...
  'chat.consult.rejection.agentUnknown': 'Doradca {index}: agent „{agent}” jest niedostępny',
  'chat.consult.rejection.agentNotPrimary': 'Doradca {index}: agent „{agent}” nie jest agentem podstawowym',
  'chat.consult.rejection.unknown': 'Doradca {index}: ten wybór jest niedostępny',
} as const;
