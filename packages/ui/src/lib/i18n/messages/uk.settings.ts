...
"settings.remoteInstances.clientAuth.actions.addDevice": "Додати пристрій",
  ...
  "settings.openchamber.opencodeCli.field.idleInstanceTimeout": "Звільняти неактивні екземпляри після",
  "settings.openchamber.opencodeCli.field.idleInstanceTimeoutInfo": "Керовані екземпляри OpenCode звільняються після цього часу без активності. Звільнення вивільняє пам'ять серверів MCP, мовних серверів і кешів, які утримує неактивний проєкт; перша дія в цьому проєкті після цього триває довше, поки екземпляр запускається знову.",
  "settings.openchamber.opencodeCli.option.idleInstanceTimeout.never": "Ніколи",
  "settings.openchamber.opencodeCli.option.idleInstanceTimeout.15m": "15 хвилин",
  "settings.openchamber.opencodeCli.option.idleInstanceTimeout.30m": "30 хвилин",
  "settings.openchamber.opencodeCli.option.idleInstanceTimeout.1h": "1 година",
  "settings.openchamber.opencodeCli.option.idleInstanceTimeout.4h": "4 години",
