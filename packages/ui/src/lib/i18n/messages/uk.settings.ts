...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'Скопіюйте повний заголовок Cookie із заголовків запиту в інструментах розробника браузера на ollama.com і вставте його сюди. Він має містити aid=... і актуальний cookie wos-session=... (старі облікові записи можуть використовувати __Secure-session=...). Збережіть також інші cookie. Це не локальний API-ключ і не локальна кінцева точка Ollama. OpenChamber ніколи не сканує сховище cookie браузера.',
