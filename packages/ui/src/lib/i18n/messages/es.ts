...
export const dict: Record<I18nKey, string> = {
  ...
  "session.githubIssuePicker.overridesHelper": "Estas selecciones solo se aplican al mensaje inicial de la sesión",
  ...
  "session.newWorktree.overridesHelper": "Estas selecciones solo se aplican al mensaje inicial de la sesión",
