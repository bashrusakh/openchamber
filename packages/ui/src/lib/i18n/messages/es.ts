...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.consult.action.hint': 'Pregunta primero a otros modelos; sus respuestas pueden añadirse como pista privada',
  'chat.consult.unavailable.noSession': 'Abre una sesión para consultar a otros modelos',
  'chat.consult.unavailable.slashCommand': 'Consultar modelos no está disponible para comandos con barra',
  'chat.consult.unavailable.shellCommand': 'Consultar modelos no está disponible para comandos de shell',
  'chat.consult.unavailable.active': 'Ya hay una consulta en curso en esta sesión',
  ...
  'chat.consult.dialog.actingLabel': 'Modelo activo',
  'chat.consult.dialog.advisorsLabel': 'Asesores',
  'chat.consult.dialog.modeLabel': 'Ejecución',
  'chat.consult.dialog.mode.parallel': 'En paralelo',
  'chat.consult.dialog.mode.sequential': 'Secuencial',
  'chat.consult.dialog.timeoutLabel': 'Tiempo límite por asesor',
  ...
  'chat.consult.dialog.privacy': 'Los asesores reciben tu mensaje, el contexto actual y los archivos adjuntos. Se ejecutan como sesiones temporales con las herramientas desactivadas y nunca ven las respuestas de los demás.',
  'chat.consult.dialog.actions.cancel': 'Cancelar',
  'chat.consult.dialog.actions.submit': 'Consultar y enviar',
  'chat.consult.dialog.actions.submitting': 'Iniciando…',
  'chat.consult.dialog.noAdvisorAgent': 'No hay ningún agente principal disponible para los asesores',
  'chat.consult.panel.ready': '{ready} / {total} listos',
  'chat.consult.summary.segment': '{count} {status}',
  'chat.consult.panel.title': 'Consultar modelos',
  'chat.consult.panel.phase.waitingAdmission': 'Esperando a la cola y a que la sesión esté inactiva…',
  'chat.consult.panel.phase.consulting': 'Consultando a {count} asesores…',
  'chat.consult.panel.phase.settling': 'Recopilando respuestas…',
  'chat.consult.panel.phase.dispatching': 'Enviando la respuesta del modelo activo…',
  'chat.consult.panel.phase.done': 'Consulta finalizada',
  'chat.consult.panel.phase.failed': 'La consulta falló',
  'chat.consult.panel.phase.cancelled': 'Consulta cancelada',
  'chat.consult.panel.degraded': 'Los asesores no produjeron respuestas utilizables; el mensaje se envió con un aviso',
  'chat.consult.panel.cancel': 'Cancelar la consulta',
  'chat.consult.panel.dismiss': 'Descartar',
  'chat.consult.status.queued': 'En cola',
  'chat.consult.status.running': 'En curso',
  'chat.consult.status.ok': 'Respondido',
  'chat.consult.status.failed': 'Falló',
  'chat.consult.status.timeout': 'Tiempo agotado',
  'chat.consult.status.empty': 'Sin respuesta',
  'chat.consult.status.cancelled': 'Cancelado',
  'chat.consult.duration.seconds': '{seconds} s',
  'chat.consult.receipt.title': 'Se consultaron {count} modelos',
  'chat.consult.receipt.degraded': 'Los asesores no produjeron respuestas utilizables',
  'chat.consult.receipt.acting': 'Activo: {model}',
  ...
  'chat.consult.rejection.agentUnknown': 'Asesor {index}: el agente «{agent}» no está disponible',
  'chat.consult.rejection.agentNotPrimary': 'Asesor {index}: el agente «{agent}» no es un agente principal',
  'chat.consult.rejection.unknown': 'Asesor {index}: esta selección no está disponible',
};
