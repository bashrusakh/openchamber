...
export const settingsDict = {
  ...
  'settings.magicPrompts.sidebar.group.composer': '컴포저',
  ...
  'settings.magicPrompts.sidebar.item.composerEnhance': '프롬프트 개선',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.magicPrompts.page.group.composerEnhance.title': '프롬프트 개선',
  ...
  'settings.magicPrompts.page.group.composerEnhance.description': '컴포저의 \'프롬프트 개선\' 작업에서 사용하는 프롬프트입니다: 전송 전에 소형 모델로 초안을 다시 쓰는 숨겨진 지침입니다.',
