...
'settings.remoteInstances.clientAuth.actions.addDevice': '기기 추가',
  ...
  'settings.openchamber.opencodeCli.field.idleInstanceTimeout': '유휴 인스턴스 해제 시간',
  'settings.openchamber.opencodeCli.field.idleInstanceTimeoutInfo': '관리되는 OpenCode 인스턴스는 이 시간 동안 활동이 없으면 해제됩니다. 해제하면 유휴 프로젝트가 보유한 MCP 서버, 언어 서버, 캐시가 정리됩니다. 이후 해당 프로젝트에서 첫 작업을 할 때는 인스턴스를 다시 시작하는 동안 잠시 기다려야 합니다.',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.never': '해제 안 함',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.15m': '15분',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.30m': '30분',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.1h': '1시간',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.4h': '4시간',
