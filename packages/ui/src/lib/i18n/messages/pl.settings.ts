...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': 'Skopiuj pełny nagłówek Cookie z nagłówków żądania w narzędziach deweloperskich przeglądarki na ollama.com i wklej go tutaj. Musi zawierać aid=... oraz bieżące cookie wos-session=... (starsze konta mogą używać __Secure-session=...). Zachowaj także pozostałe cookie. To nie jest Twój lokalny klucz API ani endpoint Ollama. OpenChamber nigdy nie skanuje plików cookie przeglądarki.',
  'settings.providers.page.ollamaCloud.cookie': 'Nagłówek Cookie',
