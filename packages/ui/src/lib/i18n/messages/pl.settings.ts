...
export const settingsDict = {
  ...
  'settings.openchamber.opencodeCli.field.idleInstanceTimeout': 'Zwalniaj bezczynne instancje po',
  'settings.openchamber.opencodeCli.field.idleInstanceTimeoutInfo': 'Zarządzane instancje OpenCode są zwalniane po tym czasie bez aktywności. Zwolnienie uwalnia pamięć serwerów MCP, serwerów językowych i pamięci podręcznych, które trzyma bezczynny projekt; pierwsza czynność w tym projekcie zajmie chwilę, zanim instancja uruchomi się ponownie.',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.never': 'Nigdy',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.15m': '15 minut',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.30m': '30 minut',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.1h': '1 godzina',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.4h': '4 godziny',
