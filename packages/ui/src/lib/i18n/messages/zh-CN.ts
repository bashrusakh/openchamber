...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.consult.action': '咨询模型',
  'chat.consult.action.hint': '先询问其他模型；它们的回答可能会作为私密提示加入',
  'chat.consult.unavailable.noSession': '请打开一个会话以咨询其他模型',
  'chat.consult.unavailable.slashCommand': '斜杠命令不可使用模型咨询',
  'chat.consult.unavailable.shellCommand': 'Shell 命令不可使用模型咨询',
  'chat.consult.unavailable.active': '此会话已有咨询正在进行',
  ...
  'chat.consult.dialog.actingLabel': '执行模型',
  'chat.consult.dialog.advisorsLabel': '顾问模型',
  'chat.consult.dialog.modeLabel': '运行方式',
  'chat.consult.dialog.mode.parallel': '并行',
  'chat.consult.dialog.mode.sequential': '顺序',
  'chat.consult.dialog.timeoutLabel': '每个顾问的超时时间',
  'chat.consult.dialog.timeout.30s': '30 秒',
  'chat.consult.dialog.timeout.1m': '1 分钟',
  'chat.consult.dialog.timeout.2m': '2 分钟',
  'chat.consult.dialog.timeout.5m': '5 分钟',
  'chat.consult.dialog.privacy': '顾问模型会收到你的消息、当前上下文和附件。它们以禁用工具的临时会话运行，也看不到彼此的回答。',
  ...
  'chat.consult.panel.phase.dispatching': '正在发送执行模型的回复…',
  'chat.consult.panel.phase.done': '咨询已完成',
  'chat.consult.panel.phase.failed': '咨询失败',
  'chat.consult.panel.phase.cancelled': '咨询已取消',
  'chat.consult.panel.degraded': '顾问没有产生可用回答；消息已附带提示发送',
  'chat.consult.panel.cancel': '取消咨询',
  'chat.consult.panel.dismiss': '关闭',
  'chat.consult.status.queued': '排队中',
  'chat.consult.status.running': '运行中',
  'chat.consult.status.ok': '已回答',
  'chat.consult.status.failed': '失败',
  'chat.consult.status.timeout': '超时',
  'chat.consult.status.empty': '无回答',
  'chat.consult.status.cancelled': '已取消',
  'chat.consult.duration.seconds': '{seconds} 秒',
  'chat.consult.receipt.title': '已咨询 {count} 个模型',
  'chat.consult.receipt.degraded': '顾问没有产生可用回答',
  'chat.consult.receipt.acting': '执行：{model}',
  ...
  'chat.consult.rejection.agentUnknown': '顾问 {index}：代理“{agent}”不可用',
  'chat.consult.rejection.agentNotPrimary': '顾问 {index}：代理“{agent}”不是主代理',
  'chat.consult.rejection.unknown': '顾问 {index}：此选择不可用',
};
