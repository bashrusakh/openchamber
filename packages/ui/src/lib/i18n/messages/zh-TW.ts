...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.consult.action': '諮詢模型',
  'chat.consult.action.hint': '先詢問其他模型；它們的回答可能會作為私密提示加入',
  'chat.consult.unavailable.noSession': '請開啟工作階段以諮詢其他模型',
  'chat.consult.unavailable.slashCommand': '斜線指令無法使用模型諮詢',
  'chat.consult.unavailable.shellCommand': 'Shell 指令無法使用模型諮詢',
  'chat.consult.unavailable.active': '此工作階段已有諮詢正在進行',
  ...
  'chat.consult.dialog.actingLabel': '執行模型',
  'chat.consult.dialog.advisorsLabel': '顧問模型',
  'chat.consult.dialog.modeLabel': '執行方式',
  'chat.consult.dialog.mode.parallel': '並行',
  'chat.consult.dialog.mode.sequential': '循序',
  'chat.consult.dialog.timeoutLabel': '每個顧問的逾時時間',
  'chat.consult.dialog.timeout.30s': '30 秒',
  'chat.consult.dialog.timeout.1m': '1 分鐘',
  'chat.consult.dialog.timeout.2m': '2 分鐘',
  'chat.consult.dialog.timeout.5m': '5 分鐘',
  'chat.consult.dialog.privacy': '顧問模型會收到你的訊息、目前內容與附件。它們以停用工具的臨時工作階段執行，也看不到彼此的回答。',
  'chat.consult.dialog.actions.cancel': '取消',
  ...
  'chat.consult.panel.phase.settling': '正在收集回答…',
  'chat.consult.panel.phase.dispatching': '正在送出執行模型的回覆…',
  'chat.consult.panel.phase.done': '諮詢已完成',
  'chat.consult.panel.phase.failed': '諮詢失敗',
  'chat.consult.panel.phase.cancelled': '諮詢已取消',
  'chat.consult.panel.degraded': '顧問沒有產生可用回答；訊息已附帶提示送出',
  'chat.consult.panel.cancel': '取消諮詢',
  'chat.consult.panel.dismiss': '關閉',
  'chat.consult.status.queued': '排隊中',
  'chat.consult.status.running': '執行中',
  'chat.consult.status.ok': '已回答',
  'chat.consult.status.failed': '失敗',
  'chat.consult.status.timeout': '逾時',
  'chat.consult.status.empty': '沒有回答',
  'chat.consult.status.cancelled': '已取消',
  'chat.consult.duration.seconds': '{seconds} 秒',
  'chat.consult.receipt.title': '已諮詢 {count} 個模型',
  'chat.consult.receipt.degraded': '顧問沒有產生可用回答',
  'chat.consult.receipt.acting': '執行：{model}',
  ...
  'chat.consult.rejection.agentUnknown': '顧問 {index}：代理「{agent}」無法使用',
  'chat.consult.rejection.agentNotPrimary': '顧問 {index}：代理「{agent}」不是主要代理',
  'chat.consult.rejection.unknown': '顧問 {index}：此選擇無法使用',
};
