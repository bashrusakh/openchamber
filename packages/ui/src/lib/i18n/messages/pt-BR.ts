...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.consult.action': 'Consultar modelos',
  'chat.consult.action.hint': 'Pergunte primeiro a outros modelos; as respostas deles podem ser adicionadas como dica privada',
  'chat.consult.unavailable.noSession': 'Abra uma sessão para consultar outros modelos',
  'chat.consult.unavailable.slashCommand': 'Consultar modelos não está disponível para comandos de barra',
  'chat.consult.unavailable.shellCommand': 'Consultar modelos não está disponível para comandos de shell',
  'chat.consult.unavailable.active': 'Já existe uma consulta em andamento nesta sessão',
  'chat.consult.unavailable.autoReview': 'Consultar modelos não está disponível enquanto o ciclo de revisão de código está em andamento nesta sessão',
  'chat.consult.unavailable.btw': 'Consultar modelos não está disponível enquanto uma sessão btw estiver ativa',
  'chat.consult.unavailable.runtime': 'Consultar modelos precisa da fila de mensagens do servidor OpenChamber e não está disponível aqui',
  'chat.consult.unavailable.checkingVersion': 'Verificando a versão do OpenCode do servidor conectado…',
  'chat.consult.unavailable.versionUnknown': 'Consultar modelos precisa do OpenCode {version} ou mais recente; não foi possível verificar a versão do servidor conectado.',
  'chat.consult.unavailable.versionUnsupported': 'Consultar modelos não está disponível porque o OpenCode {version} é mais antigo que a versão suportada {minVersion}.',
  'chat.consult.unavailable.backendProtocol': 'Consultar modelos precisa de um servidor OpenChamber mais recente: o backend conectado não suporta o protocolo da fila de consultas.',

  'chat.consult.dialog.title': 'Consultar modelos',
  'chat.consult.dialog.description': 'Pergunte primeiro a outros modelos a mesma coisa. As respostas podem ser adicionadas como dica privada por um turno; o modelo ativo continua escrevendo a resposta.',
  'chat.consult.dialog.actingLabel': 'Modelo ativo',
  'chat.consult.dialog.advisorsLabel': 'Consultores',
  'chat.consult.dialog.modeLabel': 'Execução',
  'chat.consult.dialog.mode.parallel': 'Em paralelo',
  'chat.consult.dialog.mode.sequential': 'Sequencial',
  'chat.consult.dialog.timeoutLabel': 'Tempo limite por consultor',
  'chat.consult.dialog.timeout.30s': '30 s',
  'chat.consult.dialog.timeout.1m': '1 min',
  'chat.consult.dialog.timeout.2m': '2 min',
  'chat.consult.dialog.timeout.5m': '5 min',
  'chat.consult.dialog.privacy': 'Os consultores recebem sua mensagem, o contexto atual e os anexos. Eles rodam como sessões temporárias com as ferramentas desativadas e nunca veem as respostas uns dos outros.',
  'chat.consult.dialog.actions.cancel': 'Cancelar',
  'chat.consult.dialog.actions.submit': 'Consultar e enviar',
  'chat.consult.dialog.actions.submitting': 'Iniciando…',
  'chat.consult.dialog.noAdvisorAgent': 'Nenhum agente principal está disponível para os consultores',
  'chat.consult.panel.ready': '{ready} / {total} prontos',
  'chat.consult.summary.segment': '{count} {status}',
  'chat.consult.panel.title': 'Consultar modelos',
  'chat.consult.panel.phase.waitingAdmission': 'Aguardando a fila e a sessão ficar ociosa…',
  'chat.consult.panel.phase.consulting': 'Consultando {count} consultores…',
  'chat.consult.panel.phase.settling': 'Coletando respostas…',
  'chat.consult.panel.phase.dispatching': 'Enviando a resposta do modelo ativo…',
  'chat.consult.panel.phase.done': 'Consulta concluída',
  'chat.consult.panel.phase.failed': 'A consulta falhou',
  'chat.consult.panel.phase.cancelled': 'Consulta cancelada',
  'chat.consult.panel.degraded': 'Nenhuma resposta útil dos consultores; a mensagem foi enviada com um aviso',
  'chat.consult.panel.cancel': 'Cancelar consulta',
  'chat.consult.panel.dismiss': 'Dispensar',
  'chat.consult.status.queued': 'Na fila',
  'chat.consult.status.running': 'Em execução',
  'chat.consult.status.ok': 'Respondido',
  'chat.consult.status.failed': 'Falhou',
  'chat.consult.status.timeout': 'Tempo esgotado',
  'chat.consult.status.empty': 'Sem resposta',
  'chat.consult.status.cancelled': 'Cancelado',
  'chat.consult.duration.seconds': '{seconds} s',
  'chat.consult.receipt.title': '{count} modelos consultados',
  'chat.consult.receipt.degraded': 'Nenhuma resposta útil dos consultores',
  'chat.consult.receipt.acting': 'Ativo: {model}',
  'chat.consult.toast.failed': 'A consulta falhou',
  'chat.consult.toast.refused': 'A consulta não foi iniciada: alguns consultores não estão disponíveis',
  'chat.consult.toast.deliveredRaw': 'A mensagem não está mais na fila e não foi consultada. Ela pode já ter sido enviada, então verifique a sessão.',
  'chat.consult.queue.resume': 'Retomar a consulta',
  'chat.consult.rejection.providerUnknown': 'Consultor {index}: o provedor “{provider}” não está disponível',
  'chat.consult.rejection.modelUnknown': 'Consultor {index}: o modelo “{model}” não está disponível',
  'chat.consult.rejection.variantUnknown': 'Consultor {index}: a variante “{variant}” não está disponível para “{model}”',
  'chat.consult.rejection.agentUnknown': 'Consultor {index}: o agente “{agent}” não está disponível',
  'chat.consult.rejection.agentNotPrimary': 'Consultor {index}: o agente “{agent}” não é um agente principal',
  'chat.consult.rejection.unknown': 'Consultor {index}: esta seleção não está disponível',
};
