...
export const dict: Record<I18nKey, string> = {
  ...
  "session.githubIssuePicker.overridesHelper": "Estas seleções se aplicam apenas à mensagem inicial da sessão",
  ...
  "session.newWorktree.overridesHelper": "Estas seleções se aplicam apenas à mensagem inicial da sessão",
