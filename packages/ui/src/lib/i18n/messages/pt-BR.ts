...
export const dict: Record<I18nKey, string> = {
  ...
  "session.githubIssuePicker.overridesHelper": "Estas seleções se aplicam a esta sessão (não aos seus padrões salvos)",
  ...
  "session.newWorktree.overridesHelper": "Estas seleções se aplicam a esta sessão (não aos seus padrões salvos)",
