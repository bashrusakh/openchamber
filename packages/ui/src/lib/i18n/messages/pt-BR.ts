...
export const dict: Record<I18nKey, string> = {
  ...
  "chat.chatInput.actions.enhancePromptAria": "Aprimorar o prompt",
  "chat.chatInput.actions.enhancePromptCancel": "Cancelar o aprimoramento do prompt",
  ...
  "chat.chatInput.toast.enhanceUnavailable": "Não há um modelo pequeno disponível para aprimorar o prompt. Escolha um em Ajustes → Sessões → Modelo pequeno.",
  "chat.chatInput.toast.enhanceContextTooSmall": "O prompt é grande demais para o contexto do modelo pequeno. Encurte-o ou anexe-o como arquivo.",
  "chat.chatInput.toast.enhanceEmptyResult": "O modelo pequeno retornou um prompt vazio. Tente novamente.",
  "chat.chatInput.toast.enhanceInvalidResult": "O prompt aprimorado alteraria suas referências @, / ou #. O rascunho permaneceu inalterado.",
  "chat.chatInput.toast.enhanceTimedOut": "O aprimoramento do prompt expirou. Tente novamente.",
