...
export const dict: Record<I18nKey, string> = {
  ...
  "sessions.sidebar.dialogs.worktreeDelete.disposition.label": "Sessões vinculadas",
  "sessions.sidebar.dialogs.worktreeDelete.disposition.archive": "Arquivar sessões vinculadas",
  "sessions.sidebar.dialogs.worktreeDelete.disposition.delete": "Excluir sessões vinculadas permanentemente",
  "sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionOneLinked": "Esta ação remove o worktree selecionado e exclui permanentemente {count} sessão vinculada.",
  "sessions.sidebar.dialogs.worktreeDelete.deleteDescriptionManyLinked": "Esta ação remove o worktree selecionado e exclui permanentemente {count} sessões vinculadas.",
