...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.consult.action': 'Порадитися з моделями',
  'chat.consult.action.hint': 'Спершу запитайте інші моделі; їхні відповіді можуть бути додані як приватна підказка',
  'chat.consult.unavailable.noSession': 'Відкрийте сесію, щоб порадитися з іншими моделями',
  'chat.consult.unavailable.slashCommand': 'Поради з моделями недоступні для слеш-команд',
  'chat.consult.unavailable.shellCommand': 'Поради з моделями недоступні для команд оболонки',
  'chat.consult.unavailable.active': 'У цій сесії вже виконується консультація',
  ...
  'chat.consult.dialog.advisorsLabel': 'Моделі-радники',
  'chat.consult.dialog.modeLabel': 'Режим',
  'chat.consult.dialog.mode.parallel': 'Паралельно',
  'chat.consult.dialog.mode.sequential': 'Послідовно',
  'chat.consult.dialog.timeoutLabel': 'Час очікування на радника',
  'chat.consult.dialog.timeout.30s': '30 с',
  'chat.consult.dialog.timeout.1m': '1 хв',
  'chat.consult.dialog.timeout.2m': '2 хв',
  'chat.consult.dialog.timeout.5m': '5 хв',
  'chat.consult.dialog.privacy': 'Моделі-радники отримують ваше повідомлення, поточний контекст і вкладення. Вони працюють як тимчасові сесії з вимкненими інструментами й не бачать відповідей одне одного.',
  'chat.consult.dialog.actions.cancel': 'Скасувати',
  ...
  'chat.consult.panel.phase.settling': 'Збираємо відповіді…',
  'chat.consult.panel.phase.dispatching': 'Надсилаємо відповідь активної моделі…',
  'chat.consult.panel.phase.done': 'Консультацію завершено',
  'chat.consult.panel.phase.failed': 'Консультація не вдалася',
  'chat.consult.panel.phase.cancelled': 'Консультацію скасовано',
  'chat.consult.panel.degraded': 'Радники не дали придатних відповідей; повідомлення надіслано з приміткою',
  'chat.consult.panel.cancel': 'Скасувати консультацію',
  'chat.consult.panel.dismiss': 'Закрити',
  'chat.consult.status.queued': 'У черзі',
  'chat.consult.status.running': 'Виконується',
  'chat.consult.status.ok': 'Відповіли',
  'chat.consult.status.failed': 'Помилка',
  'chat.consult.status.timeout': 'Час вичерпано',
  'chat.consult.status.empty': 'Немає відповіді',
  'chat.consult.status.cancelled': 'Скасовано',
  'chat.consult.duration.seconds': '{seconds} с',
  'chat.consult.receipt.title': 'Опитано {count} моделей',
  'chat.consult.receipt.degraded': 'Радники не дали придатних відповідей',
  'chat.consult.receipt.acting': 'Активна: {model}',
  ...
  'chat.consult.rejection.agentUnknown': 'Радник {index}: агент «{agent}» недоступний',
  'chat.consult.rejection.agentNotPrimary': 'Радник {index}: агент «{agent}» не є основним агентом',
  'chat.consult.rejection.unknown': 'Радник {index}: цей вибір недоступний',
};
