...
"settings.remoteInstances.clientAuth.actions.addDevice": "Añadir un dispositivo",
  ...
  "settings.openchamber.opencodeCli.field.idleInstanceTimeout": "Liberar las instancias inactivas después de",
  "settings.openchamber.opencodeCli.field.idleInstanceTimeoutInfo": "Las instancias gestionadas de OpenCode se liberan tras este tiempo sin actividad. La liberación devuelve la memoria de los servidores MCP, los servidores de lenguaje y las cachés que retiene un proyecto inactivo; la primera acción en ese proyecto tarda un poco más mientras la instancia vuelve a iniciarse.",
