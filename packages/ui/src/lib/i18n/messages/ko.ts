...
export const dict: Record<I18nKey, string> = {
  ...
  'chat.consult.action': '모델에 자문',
  'chat.consult.action.hint': '먼저 다른 모델에 질문하면 그 답변이 비공개 힌트로 추가될 수 있습니다',
  'chat.consult.unavailable.noSession': '다른 모델에 자문하려면 세션을 여세요',
  'chat.consult.unavailable.slashCommand': '슬래시 명령에는 모델 자문을 사용할 수 없습니다',
  'chat.consult.unavailable.shellCommand': '셸 명령에는 모델 자문을 사용할 수 없습니다',
  'chat.consult.unavailable.active': '이 세션에서 이미 자문이 실행 중입니다',
  ...
  'chat.consult.unavailable.checkingVersion': '연결된 서버의 OpenCode 버전을 확인하는 중…',
  ...
  'chat.consult.unavailable.backendProtocol': '모델 자문에는 더 새로운 OpenChamber 서버가 필요합니다. 연결된 백엔드가 자문 큐 프로토콜을 지원하지 않습니다.',
  ...
  'chat.consult.dialog.advisorsLabel': '자문 모델',
  'chat.consult.dialog.modeLabel': '실행 방식',
  'chat.consult.dialog.mode.parallel': '병렬',
  'chat.consult.dialog.mode.sequential': '순차',
  'chat.consult.dialog.timeoutLabel': '자문 모델별 제한 시간',
  'chat.consult.dialog.timeout.30s': '30초',
  'chat.consult.dialog.timeout.1m': '1분',
  'chat.consult.dialog.timeout.2m': '2분',
  'chat.consult.dialog.timeout.5m': '5분',
  'chat.consult.dialog.privacy': '자문 모델은 메시지, 현재 컨텍스트, 첨부 파일을 받습니다. 도구가 비활성화된 임시 세션으로 실행되며 서로의 답변을 볼 수 없습니다.',
  'chat.consult.dialog.actions.cancel': '취소',
  ...
  'chat.consult.panel.phase.settling': '답변을 수집하는 중…',
  'chat.consult.panel.phase.dispatching': '실행 모델의 답장을 전송하는 중…',
  'chat.consult.panel.phase.done': '자문 완료',
  'chat.consult.panel.phase.failed': '자문 실패',
  'chat.consult.panel.phase.cancelled': '자문 취소됨',
  'chat.consult.panel.degraded': '자문 모델에서 쓸 만한 답변이 없어 안내와 함께 메시지를 전송했습니다',
  'chat.consult.panel.cancel': '자문 취소',
  'chat.consult.panel.dismiss': '닫기',
  'chat.consult.status.queued': '대기 중',
  'chat.consult.status.running': '실행 중',
  'chat.consult.status.ok': '답변함',
  'chat.consult.status.failed': '실패',
  'chat.consult.status.timeout': '시간 초과',
  'chat.consult.status.empty': '답변 없음',
  'chat.consult.status.cancelled': '취소됨',
  'chat.consult.duration.seconds': '{seconds}초',
  'chat.consult.receipt.title': '{count}개 모델에 자문함',
  'chat.consult.receipt.degraded': '자문 모델에서 쓸 만한 답변이 없음',
  'chat.consult.receipt.acting': '실행: {model}',
  ...
  'chat.consult.rejection.agentUnknown': '어드바이저 {index}: 에이전트 "{agent}"을(를) 사용할 수 없습니다',
  'chat.consult.rejection.agentNotPrimary': '어드바이저 {index}: 에이전트 "{agent}"은(는) 기본 에이전트가 아닙니다',
  'chat.consult.rejection.unknown': '어드바이저 {index}: 이 선택은 사용할 수 없습니다',
};
