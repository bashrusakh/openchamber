...
export const settingsDict = {
  ...
  'settings.openchamber.opencodeCli.field.idleInstanceTimeout': 'Release idle instances after',
  'settings.openchamber.opencodeCli.field.idleInstanceTimeoutInfo': 'Managed OpenCode instances are released after this long without activity. Releasing frees the MCP servers, language servers, and caches an idle project holds; the first action there afterwards takes a moment while the instance starts again.',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.never': 'Never',
  ...
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.1h': '1 hour',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.4h': '4 hours',
