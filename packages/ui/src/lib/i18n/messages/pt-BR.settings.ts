...
"settings.remoteInstances.clientAuth.actions.addDevice": "Adicionar um dispositivo",
  ...
  "settings.openchamber.opencodeCli.field.idleInstanceTimeout": "Liberar instâncias inativas após",
  "settings.openchamber.opencodeCli.field.idleInstanceTimeoutInfo": "As instâncias gerenciadas do OpenCode são liberadas após este tempo sem atividade. A liberação devolve a memória dos servidores MCP, dos servidores de linguagem e dos caches que um projeto inativo mantém; a primeira ação nesse projeto depois disso leva um instante enquanto a instância inicia de novo.",
  "settings.openchamber.opencodeCli.option.idleInstanceTimeout.never": "Nunca",
  "settings.openchamber.opencodeCli.option.idleInstanceTimeout.15m": "15 minutos",
  "settings.openchamber.opencodeCli.option.idleInstanceTimeout.30m": "30 minutos",
  "settings.openchamber.opencodeCli.option.idleInstanceTimeout.1h": "1 hora",
  "settings.openchamber.opencodeCli.option.idleInstanceTimeout.4h": "4 horas",
