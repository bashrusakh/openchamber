...
export const dict = {
  ...
  'chat.consult.action': 'Consulter des modèles',
  'chat.consult.action.hint': 'Interrogez d’abord d’autres modèles ; leurs réponses peuvent être ajoutées comme indice privé',
  'chat.consult.unavailable.noSession': 'Ouvrez une session pour consulter d’autres modèles',
  'chat.consult.unavailable.slashCommand': 'Consulter des modèles n’est pas disponible pour les commandes slash',
  'chat.consult.unavailable.shellCommand': 'Consulter des modèles n’est pas disponible pour les commandes shell',
  'chat.consult.unavailable.active': 'Une consultation est déjà en cours dans cette session',
  ...
  'chat.consult.unavailable.checkingVersion': 'Vérification de la version d’OpenCode du serveur connecté…',
  ...
  'chat.consult.unavailable.backendProtocol': 'Consulter des modèles nécessite un serveur OpenChamber plus récent : le backend connecté ne prend pas en charge le protocole de file d’attente des consultations.',
  ...
  'chat.consult.dialog.advisorsLabel': 'Conseillers',
  'chat.consult.dialog.modeLabel': 'Exécution',
  'chat.consult.dialog.mode.parallel': 'En parallèle',
  'chat.consult.dialog.mode.sequential': 'Séquentiel',
  'chat.consult.dialog.timeoutLabel': 'Délai par conseiller',
  ...
  'chat.consult.dialog.privacy': 'Les conseillers reçoivent votre message, le contexte actuel et les pièces jointes. Ils s’exécutent dans des sessions temporaires avec les outils désactivés et ne voient jamais les réponses des autres.',
  'chat.consult.dialog.actions.cancel': 'Annuler',
  ...
  'chat.consult.panel.phase.settling': 'Collecte des réponses…',
  'chat.consult.panel.phase.dispatching': 'Envoi de la réponse du modèle actif…',
  'chat.consult.panel.phase.done': 'Consultation terminée',
  'chat.consult.panel.phase.failed': 'La consultation a échoué',
  'chat.consult.panel.phase.cancelled': 'Consultation annulée',
  'chat.consult.panel.degraded': 'Aucune réponse exploitable des conseillers ; le message a été envoyé avec un avertissement',
  'chat.consult.panel.cancel': 'Annuler la consultation',
  'chat.consult.panel.dismiss': 'Ignorer',
  'chat.consult.status.queued': 'En file d’attente',
  'chat.consult.status.running': 'En cours',
  'chat.consult.status.ok': 'Répondu',
  'chat.consult.status.failed': 'Échec',
  'chat.consult.status.timeout': 'Délai dépassé',
  'chat.consult.status.empty': 'Sans réponse',
  'chat.consult.status.cancelled': 'Annulé',
  'chat.consult.duration.seconds': '{seconds} s',
  'chat.consult.receipt.title': '{count} modèles consultés',
  'chat.consult.receipt.degraded': 'Aucune réponse exploitable des conseillers',
  'chat.consult.receipt.acting': 'Actif : {model}',
  ...
  'chat.consult.rejection.agentUnknown': "Conseiller {index} : l'agent « {agent} » n'est pas disponible",
  'chat.consult.rejection.agentNotPrimary': "Conseiller {index} : l'agent « {agent} » n'est pas un agent principal",
  'chat.consult.rejection.unknown': "Conseiller {index} : cette sélection n'est pas disponible",
} as const;
