...
export const settingsDict = {
  ...
  'settings.providers.page.ollamaCloud.help': '請從 ollama.com 瀏覽器開發者工具的要求標頭中複製完整的 Cookie 標頭，然後貼到這裡。它必須包含 aid=... 和目前的 wos-session=... Cookie（舊帳戶可能使用 __Secure-session=...）。也請保留其他 Cookie。這不是本機 Ollama API 金鑰或端點。OpenChamber 絕不會掃描瀏覽器 Cookie 儲存空間。',
  'settings.providers.page.ollamaCloud.cookie': 'Cookie 標頭',
