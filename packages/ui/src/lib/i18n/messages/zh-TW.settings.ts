...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.openchamber.opencodeCli.field.idleInstanceTimeout': '閒置執行個體釋放時間',
  'settings.openchamber.opencodeCli.field.idleInstanceTimeoutInfo': '受管理的 OpenCode 執行個體在這段時間沒有活動後會被釋放。釋放會釋出閒置專案佔用的 MCP 伺服器、語言伺服器與快取記憶體；之後在該專案中的第一個操作會稍慢，因為執行個體需要重新啟動。',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.never': '永不',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.15m': '15 分鐘',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.30m': '30 分鐘',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.1h': '1 小時',
  'settings.openchamber.opencodeCli.option.idleInstanceTimeout.4h': '4 小時',
