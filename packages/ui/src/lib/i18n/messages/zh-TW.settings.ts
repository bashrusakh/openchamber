...
export const settingsDict = {
  ...
  'settings.magicPrompts.sidebar.group.composer': '輸入框',
  ...
  'settings.magicPrompts.sidebar.item.composerEnhance': '提示詞最佳化',
...
'settings.remoteInstances.clientAuth.actions.addDevice': '新增裝置',
  ...
  'settings.magicPrompts.page.group.composerEnhance.title': '提示詞最佳化',
  'settings.magicPrompts.page.group.sessionFusion.description': '用於將 multi-run 輸出合併為一個最終答案的提示詞：可見使用者訊息 + 結果前的隱藏說明。',
  'settings.magicPrompts.page.group.composerEnhance.description': '輸入框「最佳化提示詞」操作使用的提示詞：在送出前由小型模型重寫草稿的隱藏說明。',
