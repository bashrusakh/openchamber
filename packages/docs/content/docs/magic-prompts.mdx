...
2. Pick a prompt from the groups in the sidebar — Git, GitHub, Linear, Planning, Session, and Composer.
...
| Prompt | Where it runs | When it fires |
| --- | --- | --- |
| Prompt Enhancer Instructions | The Enhance Prompt button in the chat composer | You click **Enhance Prompt**. The Small Model semantically normalizes your current draft into a clearer, more actionable instruction — preserving your intent, constraints, action level, and `@`/`#` references without adding unsupported facts. |
