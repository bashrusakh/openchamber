...
| Prompt | Where it runs | When it fires |
| --- | --- | --- |
| Prompt Enhancer Instructions | The Enhance Prompt button in the chat composer | You click **Enhance Prompt**. The Small Model rewrites your current draft for clarity, leaving your intent, constraints, and `@`/`#` references intact. |
